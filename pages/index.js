...
export default function Home() {
  ...
  Eu apoio a candidatura de: Wesley Coutinho e Tainã Ribeiro Dias para o CONSU, para ocupar as posições de representante discente no CONSU e suplente, respectivamente.
`

  const [mensagem, setMensagem] = React.useState(textoMensagem);

  const submit = () => {
    console.log(name, tia, curso, semestre);
    window.location.href(`mailto:fernandasmendonca@outlook.com?subject=ELEIÇÕES CONSU 2022&body=${mensagem}`);
  }
